defmodule Flyster.Accounts.User do
  ...
  defp maybe_validate_unique_email(changeset, opts) do
    if Keyword.get(opts, :validate_email, true) do
      changeset
      |> unsafe_validate_unique(:email, Flyster.Repo)
      |> unique_constraint(:email)
    else
      changeset
    end
  ...
  def personal_info_changeset(user, attrs, opts \\ []) do
    user
  ...
  def public_info_changeset(user, attrs, opts \\ []) do
    user
  ...
  """
  def valid_password?(%Flyster.Accounts.User{hashed_password: hashed_password}, password)
